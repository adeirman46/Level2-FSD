                ...
                if timestamp_list[index] > last_ts_list[index]:
                    ...
                    for det, xywh in detections:
                        ...
                        if np.isfinite(depth_value):
                            ...
                            depth_value_meters = depth_value / 1000.0  # Assuming depth is in millimeters
                            cv2.putText(image_net, f'{depth_value_meters:.2f} m', (x_min, y_min - 10),
                                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1, cv2.LINE_AA)

                            print(f"Depth of object {det.label} at ({x_center}, {y_center}): {depth_value_meters:.2f} m")
