...
parser.add_argument('--model', type=str, default='/home/irman/Documents/zed-sdk/object detection/custom detector/python/pytorch_yolov8/YOLOv8-multi-task/ultralytics/best.pt', help='Path to the YOLOv8 model')
...
while True:
    ...
    if zed.grab() == sl.ERROR_CODE.SUCCESS:
        ...
        results = model.predict(bitwise_frame, conf=args.conf, iou=0.45, device=[0], imgsz=(384,672), show_labels=False, save=False)
